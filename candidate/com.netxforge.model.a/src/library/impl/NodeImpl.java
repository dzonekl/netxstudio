...
public class NodeImpl extends EObjectImpl implements Node {
	...
	protected EClass eStaticClass() {
		return LibraryPackage.Literals.NODE;
	}
	...
	public EList<Resource> getResources() {
		if (resources == null) {
			resources = new EObjectContainmentEList<Resource>(Resource.class, this, LibraryPackage.NODE__RESOURCES);
		}
		return resources;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryPackage.NODE__NAME, oldName, name));
	}
	...
	public EList<Node> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<Node>(Node.class, this, LibraryPackage.NODE__NODES);
		}
		return nodes;
	}
