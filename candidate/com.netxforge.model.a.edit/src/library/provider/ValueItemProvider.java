...
/**
 * This is the item provider adapter for a {@link library.Value} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LibraryPackage.Literals.VALUE__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addTimeStampPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Value_timeStamp_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Value_timeStamp_feature", "_UI_Value_type"),
				 LibraryPackage.Literals.VALUE__TIME_STAMP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		BigDecimal labelValue = ((Value)object).getValue();
