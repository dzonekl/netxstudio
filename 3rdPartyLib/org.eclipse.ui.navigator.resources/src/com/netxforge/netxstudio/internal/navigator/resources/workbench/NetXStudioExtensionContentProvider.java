...
import com.netxforge.netxstudio.internal.navigator.resources.plugin.WorkbenchNavigatorPlugin;

/**
 * @since 3.2
 */
public class NetXStudioExtensionContentProvider extends WorkbenchContentProvider {
	 ...
	 *  
	 */
	public NetXStudioExtensionContentProvider() {
		super();
	}
	...
	// CB Changed, we have other types of objects. 
