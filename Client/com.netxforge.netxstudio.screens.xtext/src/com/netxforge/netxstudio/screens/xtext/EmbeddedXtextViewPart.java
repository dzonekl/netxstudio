 ...
 * 
 */
public class EmbeddedXtextViewPart extends AbstractEditorViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		Injector injector = InjectorProxy
				.getInjector("org.eclipse.xtext.example.arithmetics.Arithmetics");
...
//				});
	...
	protected NetXScriptWrapper getEditedEObject() {
	...
	private void reconcileChangedModel() {
		...
		if (updateEditedEObject) {
			...
			XBlockExpression astRootElement = getEditedEObject().getXblock();
