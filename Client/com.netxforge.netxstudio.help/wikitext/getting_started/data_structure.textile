...
A Resource is holding the values of a metric, but also the results of calculations. 
In contrary a metric, is specified by the vendor of the telecommunications equipment.

A Resource is created automaticly when reading in metric values, we actually give it the name of the metric.
