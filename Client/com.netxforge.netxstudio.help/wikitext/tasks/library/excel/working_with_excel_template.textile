h1. Working with an Excel Template
...
template can be imported into a NetXStudio model file (.netxstudio). 
...
!PLUGINS_ROOT/com.netxforge.netxstudio.help/img/tasks/library/excel/template_header.png!

Now we can simply populate this object, with information from the vendor:

!PLUGINS_ROOT/com.netxforge.netxstudio.help/img/tasks/library/excel/template_metric_example.png!
