...
*Report Now...* => Right-Click on a Network Element and select "Report Now..." This will initiate the creation of a resource report for this Network Element. The report can then be viewed and downloaded from the Monitoring task. 
