...
public class OperatorImpl extends CompanyImpl implements Operator {
	...
	/**
	 * The cached value of the '{@link #getExpansionExperiences() <em>Expansion Experiences</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getExpansionExperiences()
	 * @generated
	 * @ordered
	 */
	protected EList<ExpansionExperience> expansionExperiences;
	...
	public EList<ExpansionExperience> getExpansionExperiences() {
		if (expansionExperiences == null) {
			expansionExperiences = new EObjectContainmentEList<ExpansionExperience>(ExpansionExperience.class, this, OperatorsPackage.OPERATOR__EXPANSION_EXPERIENCES);
		}
		return expansionExperiences;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case OperatorsPackage.OPERATOR__EXPANSION_EXPERIENCES:
				return ((InternalEList<?>)getExpansionExperiences()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OperatorsPackage.OPERATOR__EXPANSION_EXPERIENCES:
				return getExpansionExperiences();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case OperatorsPackage.OPERATOR__RESOURCE_EXPANSIONS:
				...
				return;
			case OperatorsPackage.OPERATOR__EXPANSION_EXPERIENCES:
				getExpansionExperiences().clear();
				getExpansionExperiences().addAll((Collection<? extends ExpansionExperience>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case OperatorsPackage.OPERATOR__EXPANSION_EXPERIENCES:
				return expansionExperiences != null && !expansionExperiences.isEmpty();
		}
