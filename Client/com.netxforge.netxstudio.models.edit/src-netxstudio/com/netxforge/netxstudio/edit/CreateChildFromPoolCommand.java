 ...
 */
public class CreateChildFromPoolCommand extends CommandWrapper
  implements CommandActionDelegate
{
                               ...
                               Collection<?> selection)
  {
    return 
      domain.createCommand
        (CreateChildFromPoolCommand.class, 
   ...
   */
  protected CreateChildFromPoolCommand.Helper helper;
   ...
   * methods.
   */
  public CreateChildFromPoolCommand(EditingDomain domain,
                            EObject owner,
  ...
  public CreateChildFromPoolCommand(EditingDomain domain,
                            ...
                            Object child,
                            Collection<?> selection,
                            CreateChildFromPoolCommand.Helper helper)
  {
