...
/**
 * This is the item provider adapter for a {@link com.netxforge.netxstudio.generics.Company} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompanyItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addRSSurlPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the RS Surl feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRSSurlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Company_rSSurl_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Company_rSSurl_feature", "_UI_Company_type"),
				 GenericsPackage.Literals.COMPANY__RS_SURL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addShortNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Company_shortName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Company_shortName_feature", "_UI_Company_type"),
	...
	protected void addSymbolPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Company_symbol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Company_symbol_feature", "_UI_Company_type"),
				 GenericsPackage.Literals.COMPANY__SYMBOL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addWebsitePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Company_website_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Company_website_feature", "_UI_Company_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GenericsPackage.Literals.COMPANY__ICONS);
		}
