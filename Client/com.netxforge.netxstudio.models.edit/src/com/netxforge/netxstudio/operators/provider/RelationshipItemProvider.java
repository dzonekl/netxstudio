...
/**
 * This is the item provider adapter for a {@link com.netxforge.netxstudio.operators.Relationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationshipItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNodeID1RefPropertyDescriptor(object);
			addNodeID2RefPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Node ID1 Ref feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNodeID1RefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relationship_nodeID1Ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relationship_nodeID1Ref_feature", "_UI_Relationship_type"),
	...
	/**
	 * This adds a property descriptor for the Node ID2 Ref feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNodeID2RefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relationship_nodeID2Ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relationship_nodeID2Ref_feature", "_UI_Relationship_type"),
	...
	protected void addProtocolRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relationship_protocolRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relationship_protocolRef_feature", "_UI_Relationship_type"),
