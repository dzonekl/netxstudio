...
/**
 * This is the item provider adapter for a {@link com.netxforge.netxstudio.scheduling.WorkFlowRun} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkFlowRunItemProvider
	 ...
	 * @generated
	 */
	public WorkFlowRunItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkFlowRun_ended_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkFlowRun_ended_feature", "_UI_WorkFlowRun_type"),
	...
	protected void addLogPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkFlowRun_log_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkFlowRun_log_feature", "_UI_WorkFlowRun_type"),
	...
	protected void addProgressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkFlowRun_progress_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkFlowRun_progress_feature", "_UI_WorkFlowRun_type"),
	...
	protected void addProgressMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkFlowRun_progressMessage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkFlowRun_progressMessage_feature", "_UI_WorkFlowRun_type"),
	...
	protected void addProgressTaskPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkFlowRun_progressTask_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkFlowRun_progressTask_feature", "_UI_WorkFlowRun_type"),
	...
	protected void addStartedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkFlowRun_started_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkFlowRun_started_feature", "_UI_WorkFlowRun_type"),
	...
	protected void addStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkFlowRun_state_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkFlowRun_state_feature", "_UI_WorkFlowRun_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WorkFlowRun"));
	}
	...
	public String getText(Object object) {
		XMLGregorianCalendar labelValue = ((WorkFlowRun)object).getEnded();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_WorkFlowRun_type") :
			getString("_UI_WorkFlowRun_type") + " \"" + label + "\"";
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WorkFlowRun.class)) {
