...
public class ParameterItemProvider
	...
	protected void addExpressionNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_expressionName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_expressionName_feature", "_UI_Parameter_type"),
	...
	protected void addModifiablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_modifiable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_modifiable_feature", "_UI_Parameter_type"),
				 LibraryPackage.Literals.PARAMETER__MODIFIABLE,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Parameter_H.png"));
	}
