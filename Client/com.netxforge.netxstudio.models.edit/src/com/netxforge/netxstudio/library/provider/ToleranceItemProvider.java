...
/**
 * This is the item provider adapter for a {@link com.netxforge.netxstudio.library.Tolerance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ToleranceItemProvider
	 ...
	 * @generated
	 */
	public ToleranceItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addLevelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tolerance_level_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tolerance_level_feature", "_UI_Tolerance_type"),
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tolerance_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tolerance_name_feature", "_UI_Tolerance_type"),
	...
	public String getText(Object object) {
		String label = ((Tolerance)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Tolerance_type") :
			getString("_UI_Tolerance_type") + " " + label;
	}
