...
/**
 * This is the item provider adapter for a {@link com.netxforge.netxstudio.services.ServiceUser} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceUserItemProvider
	 ...
	 * @generated
	 */
	public ServiceUserItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceUser_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceUser_description_feature", "_UI_ServiceUser_type"),
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceUser_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceUser_name_feature", "_UI_ServiceUser_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServicesPackage.Literals.SERVICE_USER__SERVICE_PROFILE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ServiceUser"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ServiceUser.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ServicesPackage.Literals.SERVICE_USER__SERVICE_PROFILE,
				 ServicesFactory.eINSTANCE.createServiceProfile()));
	}
