...
/**
 * This is the item provider adapter for a {@link com.netxforge.netxstudio.services.ServiceMonitor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceMonitorItemProvider
	 ...
	 * @generated
	 */
	public ServiceMonitorItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceMonitor_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceMonitor_name_feature", "_UI_ServiceMonitor_type"),
	...
	protected void addRevisionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceMonitor_revision_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceMonitor_revision_feature", "_UI_ServiceMonitor_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServicesPackage.Literals.SERVICE_MONITOR__PERIOD);
			childrenFeatures.add(ServicesPackage.Literals.SERVICE_MONITOR__RESOURCE_MONITORS);
		}
	...
	/**
	 * This returns ServiceMonitor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ServiceMonitor"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ServiceMonitor.class)) {
