...
public abstract class AbstractDetailsScreen extends Composite implements
	...
	class ViewerFocusManager implements FocusListener {
		...
		public void focusGained(FocusEvent e) {
			if (e.getSource() instanceof Control) {
				System.out.println("AbstractDetailsComposite: focus gained : "
						+ e.getSource());
				if (m.containsKey(e.getSource())) {
					this.currentControl = (Control) e.getSource();
					screenService
							.fireScreenChangedExternal(AbstractDetailsScreen.this);
				}
			}
		}
		...
		public void focusLost(FocusEvent e) {
			if (e.getSource() instanceof Control) {
				System.out.println("AbstractDetailsComposite: focus lost : "
						+ e.getSource());
				currentControl = null;
			}
		}
	...
	public void handleValidationStateChange(ValidationEvent event) {
		...
		if (event instanceof FormValidationEvent) {
			...
			if (type != IMessage.NONE) {
				...
				msgBuffer.append(formStatus + "(" + list.size() + "), "
