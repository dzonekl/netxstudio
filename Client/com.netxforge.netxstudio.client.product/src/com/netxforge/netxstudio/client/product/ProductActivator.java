...
//			    lastuserValue = this.getProperties().getProperty(NETXSTUDIO_LASTUSER);
//			    serverValue = this.getProperties().getProperty(NETXSTUDIO_SERVER);
//			    workspaceValue = this.getProperties().getProperty(NETXSTUDIO_WORKSPACE);
			} catch (IOException e) {
				e.printStackTrace();
			}
			...
			if(f.createNewFile()){
				...
				this.getProperties().store(new FileOutputStream(f),NETXSTUDIO_PROPS_COMMENT );
			}
		}
	}
...
//		this.getProperties().setProperty(ProductActivator.NETXSTUDIO_SERVER, serverValue);
//		this.getProperties().setProperty(ProductActivator.NETXSTUDIO_WORKSPACE, workspaceValue);
//		this.getProperties().setProperty(ProductActivator.NETXSTUDIO_LASTUSER, lastuserValue);
