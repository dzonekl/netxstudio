...
public class AppScreenSelector extends AbstractScreenSelector {

	public static final String ID = "com.netxforge.netxstudio.screens.selector.app"; //$NON-NLS-1$
	private final FormToolkit toolkit = new FormToolkit(Display.getCurrent());

	public AppScreenSelector() {
		super();
	}
	...
	public void createPartControl(Composite parent) {
		...
		screenFormService.getSelectorForm().setText("Default Selector");
	}
...
//		Composite result;
		...
		// TODO, Read our IScreen extension to load the IScreens into the selector. 
//
