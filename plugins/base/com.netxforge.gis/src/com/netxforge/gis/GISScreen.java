...
/**
 * A screen which implements a GIS View and GeoCoding lookup.
 * 
 * @author Christophe Bouhier
 */
public class GISScreen extends AbstractScreenImpl implements
	 ...
	 * @param style
	 */
	public GISScreen(Composite parent, int style) {
		super(parent, style);
	...
	private void buildUI() {
...

				{
					...
					Listener listener = new Listener() {
						public void handleEvent(Event event) {
							...
							if(geo != null){
								 List<POI> pois = geo.executeQuery(query);
...

				{
					...
					geocodingTreeViewer.setLabelProvider(new LabelProvider() {
						...
						public String getText(Object element) {
							...
							return "unidentified object" + element;
						}
					});
				}
			}
		...
		geoMapComposite = new GeoMapComposite(mapSection, SWT.None);
