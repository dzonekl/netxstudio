 ...
 * @generated
 */
public class RestSessionSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static RestSessionPackage modelPackage;
	 ...
	 * @generated
	 */
	public RestSessionSwitch() {
		if (modelPackage == null) {
			modelPackage = RestSessionPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RestSessionPackage.REST_SESSION: {
				RestSession restSession = (RestSession)theEObject;
				T result = caseRestSession(restSession);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RestSessionPackage.PATH_FRAGMENT: {
				PathFragment pathFragment = (PathFragment)theEObject;
				T result = casePathFragment(pathFragment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RestSessionPackage.ENTITY_INFO: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Rest Session</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Rest Session</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRestSession(RestSession object) {
		return null;
	}
