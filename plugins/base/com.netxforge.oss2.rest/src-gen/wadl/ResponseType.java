 ...
 * <ul>
 *   <li>{@link wadl.ResponseType#getDoc <em>Doc</em>}</li>
 *   <li>{@link wadl.ResponseType#getParam <em>Param</em>}</li>
 *   <li>{@link wadl.ResponseType#getRepresentation <em>Representation</em>}</li>
 *   <li>{@link wadl.ResponseType#getAny <em>Any</em>}</li>
 *   <li>{@link wadl.ResponseType#getStatus <em>Status</em>}</li>
 *   <li>{@link wadl.ResponseType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @see wadl.WadlPackage#getResponseType()
...
public interface ResponseType extends EObject {
	 ...
	 * @see wadl.WadlPackage#getResponseType_Doc()
	 ...
	 * @see wadl.WadlPackage#getResponseType_Param()
	 * @model containment="true"
	 ...
	 * @see wadl.WadlPackage#getResponseType_Representation()
	 * @model containment="true"
	 ...
	 * @see wadl.WadlPackage#getResponseType_Any()
	 ...
	 * @see #setStatus(List)
	 * @see wadl.WadlPackage#getResponseType_Status()
	 * @model dataType="wadl.StatusCodeList" many="false"
	...
	/**
	 * Sets the value of the '{@link wadl.ResponseType#getStatus <em>Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setStatus(List<Long> value);
	 ...
	 * @see wadl.WadlPackage#getResponseType_AnyAttribute()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
