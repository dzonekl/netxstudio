 ...
 * <ul>
 *   <li>{@link wadl.RequestType#getDoc <em>Doc</em>}</li>
 *   <li>{@link wadl.RequestType#getParam <em>Param</em>}</li>
 *   <li>{@link wadl.RequestType#getRepresentation <em>Representation</em>}</li>
 *   <li>{@link wadl.RequestType#getAny <em>Any</em>}</li>
 *   <li>{@link wadl.RequestType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @see wadl.WadlPackage#getRequestType()
...
public interface RequestType extends EObject {
	 ...
	 * @see wadl.WadlPackage#getRequestType_Doc()
	 ...
	 * @see wadl.WadlPackage#getRequestType_Param()
	 * @model containment="true"
	 ...
	 * @see wadl.WadlPackage#getRequestType_Representation()
	 * @model containment="true"
	 ...
	 * @see wadl.WadlPackage#getRequestType_Any()
	 ...
	 * @see wadl.WadlPackage#getRequestType_AnyAttribute()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
