...
public class FilesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FilesPackage.FILES_SESSION: {
				FilesSession filesSession = (FilesSession)theEObject;
				T result = caseFilesSession(filesSession);
	 ...
	 * @generated
	 */
	public T caseFilesSession(FilesSession object) {
		return null;
	}
