...
public class FilesAdapterFactory extends AdapterFactoryImpl {
	...
	protected FilesSwitch<Adapter> modelSwitch =
		new FilesSwitch<Adapter>() {
			@Override
			public Adapter caseFilesSession(FilesSession object) {
				return createFilesSessionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link files.FilesSession <em>Session</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFilesSessionAdapter() {
		return null;
	}
