 ...
 */
public class AddonRetentionLogic extends BaseComponentLogic {
	...
	protected void doRun() throws InterruptedException {
		...
		List<Component> relevantComponents = retentionEngine()
	...
	private RetentionEngine retentionEngine() {
		BaseExpressionEngine engine = this.getEngine();
		if (engine instanceof RetentionEngine) {
			return (RetentionEngine) engine;
		}
		return null;
	}
