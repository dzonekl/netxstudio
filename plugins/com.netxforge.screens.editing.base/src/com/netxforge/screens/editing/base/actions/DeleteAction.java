...
import com.netxforge.screens.editing.base.actions.handlers.CommandActionHandler;
 ...
 * {@link RemoveCommand} or {@link DeleteCommand}. </p> Extends a custom
 * {@link CommandActionHandler} capable of retrieving the original event.
 * 
 */
public class DeleteAction extends CommandActionHandler {
	...
	public DeleteAction(EditingDomain domain, boolean removeAllReferences) {
		super(domain, EMFEditUIPlugin.INSTANCE
				.getString("_UI_Delete_menu_item"));
	...
	public Command createCommand(Collection<?> selection) {
		return removeAllReferences ? DeleteCommand.create(domain, selection)
