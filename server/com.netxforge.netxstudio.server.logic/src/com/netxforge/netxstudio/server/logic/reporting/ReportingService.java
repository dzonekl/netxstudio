		...
		private CDOID run() {
			...
			if (parameters.containsKey(NODETYPE_PARAM)) {
				...
				if (parameters.containsKey(NETWORK_SERVICE_PARAM)) {
					CDOID serviceID = CDO.cdoLongIDFromString(
			...
			// For a Single Node.
				...
				CDOID nodeID = CDO.cdoLongIDFromString(
