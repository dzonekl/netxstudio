...
public class HibernateQueryTest extends BaseTest
{
  ...
  public void testSimpleQuery() throws Exception
  {
    ...
    {
      CDOQuery cdoQuery = transaction.createQuery("hql", "from Equipment");
    ...
    {
      CDOQuery cdoQuery = transaction.createQuery("hql", "from Equipment where state=:state");
  ...
  public void testFunctions() throws Exception
  {
    ...
    {
      CDOQuery cdoQuery = transaction.createQuery("hql", "select count(*) from Equipment");
      addCacheParameter(cdoQuery);
...
//      assertEquals(NUM_OF_SALES_ORDERS * NUM_OF_CUSTOMERS, results.size());
  ...
  public void testPaging() throws Exception
  {
...

    {
      ...
      {
        CDOQuery equipmentQuery = transaction.createQuery("hql", "from Equipment");
        ...
        for (Equipment newEquipment : queriedEquipments)
        {
