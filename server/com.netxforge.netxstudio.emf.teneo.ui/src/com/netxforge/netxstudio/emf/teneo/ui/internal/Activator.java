package com.netxforge.netxstudio.emf.teneo.ui.internal;
...
import com.netxforge.netxstudio.emf.teneo.ui.cnf.TeneoAdapterFactory;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.netxforge.netxstudio.emf.teneo.ui"; //$NON-NLS-1$
	...
	public void start(BundleContext context) throws Exception {
		...
		TeneoAdapterFactory factory = new TeneoAdapterFactory();
		
		manager.registerAdapters(factory, ResourceSet.class);
		manager.registerAdapters(factory, HibernateResource.class);
		manager.registerAdapters(factory, Resource.class);
	}
