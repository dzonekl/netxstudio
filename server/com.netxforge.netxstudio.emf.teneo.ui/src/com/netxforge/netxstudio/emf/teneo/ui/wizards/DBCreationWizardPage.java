 ...
 */
public class DBCreationWizardPage extends WizardNewFileCreationPage {
	...
	/**
	 */
	public DBCreationWizardPage(String pageName,
...
//		IWizardPage prev = this.getPreviousPage();
	...
	protected boolean validatePage() {
		...
		if (extension != null
			...
			setErrorMessage(Messages.DBCreationWizardPage_1 + extension);
			return false;
		}
		return true;
	}
