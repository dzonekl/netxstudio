...
public class DBImportModelWizardPage extends WizardPage {
	...
	protected DBImportModelWizardPage(String pageName) {
		super(pageName);
	}
...
//		form.setText(Messages.ImportResourceWizardPage_0);
		...
		Button button = toolkit.createButton(sectionClient,
				Messages.ImportResourceWizardPage_5, SWT.PUSH);
	...
	private void updatePageComplete() {
		...
		if(srcPath == null || srcPath.isEmpty()){
			setMessage(null);
			setErrorMessage(Messages.ImportResourceWizardPage_6);
			return;
		}
