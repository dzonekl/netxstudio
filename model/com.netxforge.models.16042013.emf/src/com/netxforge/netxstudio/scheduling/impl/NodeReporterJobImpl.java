...
public class NodeReporterJobImpl extends JobImpl implements NodeReporterJob {
		...
		if (node != null && node.eIsProxy()) {
			...
			if (node != oldNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SchedulingPackage.NODE_REPORTER_JOB__NODE, oldNode, node));
			}
		}
		return node;
	}
	...
	public void setNode(Node newNode) {
		...
		node = newNode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulingPackage.NODE_REPORTER_JOB__NODE, oldNode, node));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchedulingPackage.NODE_REPORTER_JOB__NODE:
