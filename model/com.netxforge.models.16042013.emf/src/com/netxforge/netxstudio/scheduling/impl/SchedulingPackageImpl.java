...
import com.netxforge.netxstudio.scheduling.ExternalJob;
...
public class SchedulingPackageImpl extends EPackageImpl implements SchedulingPackage {
	 ...
	 * @generated
	 */
	private EClass externalJobEClass = null;
	 ...
	 * @generated
	 */
	public EClass getExternalJob() {
		return externalJobEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getExternalJob_ClassURI() {
		return (EAttribute)externalJobEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getExternalJob_PluginID() {
		return (EAttribute)externalJobEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		externalJobEClass = createEClass(EXTERNAL_JOB);
		createEAttribute(externalJobEClass, EXTERNAL_JOB__CLASS_URI);
		createEAttribute(externalJobEClass, EXTERNAL_JOB__PLUGIN_ID);
	...
	public void initializePackageContents() {
		...
		externalJobEClass.getESuperTypes().add(this.getJob());
		...
		initEClass(externalJobEClass, ExternalJob.class, "ExternalJob", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getExternalJob_ClassURI(), theXMLTypePackage.getAnyURI(), "classURI", null, 0, 1, ExternalJob.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExternalJob_PluginID(), theXMLTypePackage.getString(), "pluginID", null, 0, 1, ExternalJob.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
