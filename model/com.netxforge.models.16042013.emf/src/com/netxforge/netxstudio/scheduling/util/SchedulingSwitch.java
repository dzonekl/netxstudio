...
public class SchedulingSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SchedulingPackage.EXTERNAL_JOB: {
				ExternalJob externalJob = (ExternalJob)theEObject;
				T result = caseExternalJob(externalJob);
				if (result == null) result = caseJob(externalJob);
				if (result == null) result = caseBase(externalJob);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>External Job</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>External Job</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExternalJob(ExternalJob object) {
		return null;
	}
