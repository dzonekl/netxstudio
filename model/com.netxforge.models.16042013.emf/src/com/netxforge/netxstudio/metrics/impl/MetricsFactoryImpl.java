...
public class MetricsFactoryImpl extends EFactoryImpl implements MetricsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case MetricsPackage.MAPPING_COLUMN: return createMappingColumn();
			case MetricsPackage.MAPPING_CSV: return createMappingCSV();
			case MetricsPackage.MAPPING_EXTERNAL: return createMappingExternal();
	 ...
	 * @generated
	 */
	public MappingExternal createMappingExternal() {
		MappingExternalImpl mappingExternal = new MappingExternalImpl();
		return mappingExternal;
	}
