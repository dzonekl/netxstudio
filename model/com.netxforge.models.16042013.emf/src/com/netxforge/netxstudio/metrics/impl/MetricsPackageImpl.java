...
import com.netxforge.netxstudio.metrics.FixedMetricRetentionPeriod;
...
import com.netxforge.netxstudio.metrics.MetricAggregationRules;
import com.netxforge.netxstudio.metrics.MetricRetentionPeriods;
...
import com.netxforge.netxstudio.metrics.util.MetricsValidator;
...
public class MetricsPackageImpl extends EPackageImpl implements MetricsPackage {
	 ...
	 * @generated
	 */
	private EClass mappingExternalEClass = null;
	 ...
	 * @generated
	 */
	public EClass getMappingExternal() {
		return mappingExternalEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getMappingExternal_ClassURI() {
		return (EAttribute)mappingExternalEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMappingExternal_PluginID() {
		return (EAttribute)mappingExternalEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getMetricSource_MetricAggregationRules() {
		return (EReference)metricSourceEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getMetricSource_MetricRetentionRules() {
		return (EReference)metricSourceEClass.getEStructuralFeatures().get(5);
	}
	...
	public EAttribute getMetricSource_Name() {
		return (EAttribute)metricSourceEClass.getEStructuralFeatures().get(6);
	}
	...
	public void createPackageContents() {
		...
		mappingExternalEClass = createEClass(MAPPING_EXTERNAL);
		createEAttribute(mappingExternalEClass, MAPPING_EXTERNAL__CLASS_URI);
		createEAttribute(mappingExternalEClass, MAPPING_EXTERNAL__PLUGIN_ID);
		...
		createEReference(metricSourceEClass, METRIC_SOURCE__METRIC_AGGREGATION_RULES);
		createEAttribute(metricSourceEClass, METRIC_SOURCE__METRIC_LOCATION);
		createEReference(metricSourceEClass, METRIC_SOURCE__METRIC_RETENTION_RULES);
	...
	public void initializePackageContents() {
		...
		mappingExternalEClass.getESuperTypes().add(this.getMapping());
		...
		initEClass(mappingExternalEClass, MappingExternal.class, "MappingExternal", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMappingExternal_ClassURI(), theXMLTypePackage.getAnyURI(), "classURI", null, 0, 1, MappingExternal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMappingExternal_PluginID(), theXMLTypePackage.getString(), "pluginID", null, 0, 1, MappingExternal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMetricAggregationRule_AggregationExpression(), theLibraryPackage.getExpression(), null, "aggregationExpression", null, 0, 1, MetricAggregationRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMetricSource_MetricAggregationRules(), theGenericsPackage.getRuleSet(), null, "metricAggregationRules", null, 0, 1, MetricSource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMetricSource_MetricRetentionRules(), theGenericsPackage.getRuleSet(), null, "metricRetentionRules", null, 0, 1, MetricSource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (mappingExternalEClass, 
		   source, 
		   new String[] {
			 "name", "MappingExternal",
			 "kind", "elementOnly"
		   });	
		addAnnotation
		  (getMappingExternal_ClassURI(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "ClassURI"
		...
		addAnnotation
		  (getMetricSource_MetricAggregationRules(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "MetricAggregationRules"
		...
		addAnnotation
		  (getMetricSource_MetricRetentionRules(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "MetricRetentionRules"
