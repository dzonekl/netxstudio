...
public class ServiceProfileImpl extends BaseImpl implements ServiceProfile {
	 ...
	 * @ordered
	 */
	protected EList<DerivedResource> profileResources;
	...
	public EList<DerivedResource> getProfileResources() {
		if (profileResources == null) {
			profileResources = new EObjectContainmentEList<DerivedResource>(DerivedResource.class, this, ServicesPackage.SERVICE_PROFILE__PROFILE_RESOURCES);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ServicesPackage.SERVICE_PROFILE__PROFILE_RESOURCES:
				...
				getProfileResources().addAll((Collection<? extends DerivedResource>)newValue);
				return;
			case ServicesPackage.SERVICE_PROFILE__NAME:
