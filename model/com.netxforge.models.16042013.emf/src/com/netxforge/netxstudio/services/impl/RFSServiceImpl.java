...
public class RFSServiceImpl extends ServiceImpl implements RFSService {
	...
	public EList<Node> getNodes() {
		if (nodes == null) {
			nodes = new EObjectResolvingEList<Node>(Node.class, this, ServicesPackage.RFS_SERVICE__NODES);
		}
		return nodes;
	}
	...
	public EList<Tolerance> getToleranceRefs() {
		if (toleranceRefs == null) {
			toleranceRefs = new EObjectResolvingEList<Tolerance>(Tolerance.class, this, ServicesPackage.RFS_SERVICE__TOLERANCE_REFS);
		}
