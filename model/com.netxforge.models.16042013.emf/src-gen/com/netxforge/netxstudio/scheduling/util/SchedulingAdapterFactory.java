...
public class SchedulingAdapterFactory extends AdapterFactoryImpl {
	...
	protected SchedulingSwitch<Adapter> modelSwitch =
		new SchedulingSwitch<Adapter>() {
			...
			@Override
			public Adapter caseExternalJob(ExternalJob object) {
				return createExternalJobAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.netxforge.netxstudio.scheduling.ExternalJob <em>External Job</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExternalJobAdapter() {
		return null;
	}
