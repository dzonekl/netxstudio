...
public class RFSServiceReporterJobImpl extends JobImpl implements RFSServiceReporterJob {
		...
		if (rFSService != null && rFSService.eIsProxy()) {
			...
			if (rFSService != oldRFSService) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SchedulingPackage.RFS_SERVICE_REPORTER_JOB__RFS_SERVICE, oldRFSService, rFSService));
			}
		}
		return rFSService;
	}
	...
	public void setRFSService(RFSService newRFSService) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulingPackage.RFS_SERVICE_REPORTER_JOB__RFS_SERVICE, oldRFSService, rFSService));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchedulingPackage.RFS_SERVICE_REPORTER_JOB__RFS_SERVICE:
