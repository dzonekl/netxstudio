...
public class AnalyzerJobImpl extends JobImpl implements AnalyzerJob {
		...
		if (rFSService != null && rFSService.eIsProxy()) {
			...
			if (rFSService != oldRFSService) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SchedulingPackage.ANALYZER_JOB__RFS_SERVICE, oldRFSService, rFSService));
			}
		}
		return rFSService;
	}
	...
	public void setRFSService(RFSService newRFSService) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulingPackage.ANALYZER_JOB__RFS_SERVICE, oldRFSService, rFSService));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchedulingPackage.ANALYZER_JOB__RFS_SERVICE:
