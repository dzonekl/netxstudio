 ...
 *   <li>{@link com.netxforge.netxstudio.metrics.MetricSource#getMetricAggregationRules <em>Metric Aggregation Rules</em>}</li>
 *   <li>{@link com.netxforge.netxstudio.metrics.MetricSource#getMetricLocation <em>Metric Location</em>}</li>
 *   <li>{@link com.netxforge.netxstudio.metrics.MetricSource#getMetricRetentionRules <em>Metric Retention Rules</em>}</li>
...
public interface MetricSource extends Base {
	...
	/**
	 * Returns the value of the '<em><b>Metric Aggregation Rules</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * 						
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>Metric Aggregation Rules</em>' reference.
	 * @see #setMetricAggregationRules(RuleSet)
	 * @see com.netxforge.netxstudio.metrics.MetricsPackage#getMetricSource_MetricAggregationRules()
	 * @model extendedMetaData="kind='attribute' name='MetricAggregationRules'"
	 * @generated
	 */
	RuleSet getMetricAggregationRules();

	/**
	 * Sets the value of the '{@link com.netxforge.netxstudio.metrics.MetricSource#getMetricAggregationRules <em>Metric Aggregation Rules</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Metric Aggregation Rules</em>' reference.
	 * @see #getMetricAggregationRules()
	 * @generated
	 */
	void setMetricAggregationRules(RuleSet value);
	...
	/**
	 * Returns the value of the '<em><b>Metric Retention Rules</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * The MetricRetentionRules reference, references a
	 ...
	 * 						
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>Metric Retention Rules</em>' reference.
	 * @see #setMetricRetentionRules(RuleSet)
	 * @see com.netxforge.netxstudio.metrics.MetricsPackage#getMetricSource_MetricRetentionRules()
	 * @model extendedMetaData="kind='attribute' name='MetricRetentionRules'"
	 * @generated
	 */
	RuleSet getMetricRetentionRules();

	/**
	 * Sets the value of the '{@link com.netxforge.netxstudio.metrics.MetricSource#getMetricRetentionRules <em>Metric Retention Rules</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Metric Retention Rules</em>' reference.
	 * @see #getMetricRetentionRules()
	 * @generated
	 */
	void setMetricRetentionRules(RuleSet value);
