...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Object Kind Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.netxforge.netxstudio.metrics.MetricsPackage#getObjectKindType()
 * @model extendedMetaData="name='ObjectKind_._type'"
 * @generated
 */
public enum ObjectKindType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Object Kind Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ObjectKindType[] VALUES_ARRAY =
		new ObjectKindType[] {
			NODE,
			EQUIPMENT,
			FUNCTION,
	...
	/**
	 * A public read-only list of all the '<em><b>Object Kind Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ObjectKindType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Object Kind Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ObjectKindType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ObjectKindType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Object Kind Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ObjectKindType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ObjectKindType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Object Kind Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ObjectKindType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ObjectKindType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
