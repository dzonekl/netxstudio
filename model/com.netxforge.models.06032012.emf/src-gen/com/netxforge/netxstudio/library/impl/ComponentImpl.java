 ...
 *   <li>{@link com.netxforge.netxstudio.library.impl.ComponentImpl#getConfigAttributes <em>Config Attributes</em>}</li>
...
public class ComponentImpl extends BaseImpl implements Component {
	...
	/**
	 * The cached value of the '{@link #getConfigAttributes() <em>Config Attributes</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getConfigAttributes()
	 * @generated
	 * @ordered
	 */
	protected EList<ConfigAttribute> configAttributes;
	 ...
	 * @generated
	 */
	public EList<ConfigAttribute> getConfigAttributes() {
		if (configAttributes == null) {
			configAttributes = new EObjectContainmentEList<ConfigAttribute>(ConfigAttribute.class, this, LibraryPackage.COMPONENT__CONFIG_ATTRIBUTES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case LibraryPackage.COMPONENT__CONFIG_ATTRIBUTES:
				return ((InternalEList<?>)getConfigAttributes()).basicRemove(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case LibraryPackage.COMPONENT__RESOURCE_REFS:
				...
				return;
			case LibraryPackage.COMPONENT__CONFIG_ATTRIBUTES:
				getConfigAttributes().clear();
				getConfigAttributes().addAll((Collection<? extends ConfigAttribute>)newValue);
				return;
			case LibraryPackage.COMPONENT__METRIC_REFS:
				getMetricRefs().clear();
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case LibraryPackage.COMPONENT__CONFIG_ATTRIBUTES:
				return configAttributes != null && !configAttributes.isEmpty();
			case LibraryPackage.COMPONENT__METRIC_REFS:
