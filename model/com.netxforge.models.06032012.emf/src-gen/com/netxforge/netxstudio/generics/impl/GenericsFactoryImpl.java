...
public class GenericsFactoryImpl extends EFactoryImpl implements GenericsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case GenericsPackage.COMMIT_LOG_ENTRY: return createCommitLogEntry();
			case GenericsPackage.COMPANY: return createCompany();
			case GenericsPackage.CONFIG_ATTRIBUTE: return createConfigAttribute();
			...
			case GenericsPackage.EXPANSION_DURATION_SETTING: return createExpansionDurationSetting();
			case GenericsPackage.EXPANSION_DURATION_VALUE: return createExpansionDurationValue();
	 ...
	 * @generated
	 */
	public ConfigAttribute createConfigAttribute() {
		ConfigAttributeImpl configAttribute = new ConfigAttributeImpl();
