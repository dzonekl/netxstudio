...
public class ServicesFactoryImpl extends EFactoryImpl implements ServicesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ServicesPackage.DERIVED_RESOURCE: return createDerivedResource();
			case ServicesPackage.DISTRIBUTION_ENTRY: return createDistributionEntry();
			...
			case ServicesPackage.SERVICE_FLOW: return createServiceFlow();
			case ServicesPackage.SERVICE_FLOW_RELATIONSHIP: return createServiceFlowRelationship();
