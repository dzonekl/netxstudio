...
public class NetxstudioFactoryImpl extends EFactoryImpl implements NetxstudioFactory {
	...
	public static NetxstudioFactory init() {
		try {
			NetxstudioFactory theNetxstudioFactory = (NetxstudioFactory)EPackage.Registry.INSTANCE.getEFactory(NetxstudioPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case NetxstudioPackage.SERVER_SETTINGS: return createServerSettings();
			default:
