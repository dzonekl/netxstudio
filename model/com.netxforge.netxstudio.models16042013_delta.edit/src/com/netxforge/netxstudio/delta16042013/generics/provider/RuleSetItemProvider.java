 ...
 */
package com.netxforge.netxstudio.delta16042013.generics.provider;
...
/**
 * This is the item provider adapter for a {@link com.netxforge.netxstudio.delta16042013.generics.RuleSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RuleSet_rules_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RuleSet_rules_feature", "_UI_RuleSet_type"),
				 GenericsPackage.Literals.RULE_SET__RULES,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GenericsPackage.Literals.RULE_SET__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
