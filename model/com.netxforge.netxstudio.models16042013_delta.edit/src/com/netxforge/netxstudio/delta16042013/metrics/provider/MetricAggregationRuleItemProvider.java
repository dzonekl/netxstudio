...
import com.netxforge.netxstudio.delta16042013.generics.provider.RuleItemProvider;
...
/**
 * This is the item provider adapter for a {@link com.netxforge.netxstudio.delta16042013.metrics.MetricAggregationRule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetricAggregationRuleItemProvider
	 ...
	 * @generated
	 */
	public MetricAggregationRuleItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MetricAggregationRule_aggregationExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MetricAggregationRule_aggregationExpression_feature", "_UI_MetricAggregationRule_type"),
				 MetricsPackage.Literals.METRIC_AGGREGATION_RULE__AGGREGATION_EXPRESSION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIntervalHintPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MetricAggregationRule_intervalHint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MetricAggregationRule_intervalHint_feature", "_UI_MetricAggregationRule_type"),
				 MetricsPackage.Literals.METRIC_AGGREGATION_RULE__INTERVAL_HINT,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MetricAggregationRule"));
	}
	...
	public String getText(Object object) {
		String label = ((MetricAggregationRule)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MetricAggregationRule_type") :
			getString("_UI_MetricAggregationRule_type") + " " + label;
	}
