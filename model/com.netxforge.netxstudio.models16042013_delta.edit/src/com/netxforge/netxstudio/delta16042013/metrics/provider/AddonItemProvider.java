...
/**
 * This is the item provider adapter for a {@link com.netxforge.netxstudio.delta16042013.metrics.Addon} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AddonItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetricsPackage.Literals.ADDON__METRICS);
			childrenFeatures.add(MetricsPackage.Literals.ADDON__METRIC_SOURCES);
			childrenFeatures.add(MetricsPackage.Literals.ADDON__METRIC_RETENTION_RULE_SETS);
			childrenFeatures.add(MetricsPackage.Literals.ADDON__METRIC_AGGREGATION_RULE_SETS);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Addon_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetricsPackage.Literals.ADDON__METRICS,
				 MetricsFactory.eINSTANCE.createMetric()));

		newChildDescriptors.add
			(createChildParameter
				(MetricsPackage.Literals.ADDON__METRIC_SOURCES,
				 MetricsFactory.eINSTANCE.createMetricSource()));

		newChildDescriptors.add
			(createChildParameter
				(MetricsPackage.Literals.ADDON__METRIC_RETENTION_RULE_SETS,
				 MetricsFactory.eINSTANCE.createMetricRetentionRules()));

		newChildDescriptors.add
			(createChildParameter
				(MetricsPackage.Literals.ADDON__METRIC_AGGREGATION_RULE_SETS,
				 MetricsFactory.eINSTANCE.createMetricAggregationRules()));
	}
