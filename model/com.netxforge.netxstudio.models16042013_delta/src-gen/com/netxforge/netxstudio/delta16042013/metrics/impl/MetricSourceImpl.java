 ...
 * <ul>
 *   <li>{@link com.netxforge.netxstudio.delta16042013.metrics.impl.MetricSourceImpl#getMetricAggregationRuleSet <em>Metric Aggregation Rule Set</em>}</li>
 *   <li>{@link com.netxforge.netxstudio.delta16042013.metrics.impl.MetricSourceImpl#getMetricRetentionRuleSet <em>Metric Retention Rule Set</em>}</li>
 *   <li>{@link com.netxforge.netxstudio.delta16042013.metrics.impl.MetricSourceImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MetricSourceImpl extends BaseImpl implements MetricSource {
		...
		if (metricAggregationRuleSet != null && metricAggregationRuleSet.eIsProxy()) {
			...
			if (metricAggregationRuleSet != oldMetricAggregationRuleSet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetricsPackage.METRIC_SOURCE__METRIC_AGGREGATION_RULE_SET, oldMetricAggregationRuleSet, metricAggregationRuleSet));
			}
		}
	...
	public void setMetricAggregationRuleSet(MetricAggregationRules newMetricAggregationRuleSet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetricsPackage.METRIC_SOURCE__METRIC_AGGREGATION_RULE_SET, oldMetricAggregationRuleSet, metricAggregationRuleSet));
	}
	...
	public MetricRetentionRules getMetricRetentionRuleSet() {
		if (metricRetentionRuleSet != null && metricRetentionRuleSet.eIsProxy()) {
			...
			if (metricRetentionRuleSet != oldMetricRetentionRuleSet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetricsPackage.METRIC_SOURCE__METRIC_RETENTION_RULE_SET, oldMetricRetentionRuleSet, metricRetentionRuleSet));
			}
		}
	...
	public void setMetricRetentionRuleSet(MetricRetentionRules newMetricRetentionRuleSet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetricsPackage.METRIC_SOURCE__METRIC_RETENTION_RULE_SET, oldMetricRetentionRuleSet, metricRetentionRuleSet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetricsPackage.METRIC_SOURCE__METRIC_AGGREGATION_RULE_SET:
				if (resolve) return getMetricAggregationRuleSet();
				return basicGetMetricAggregationRuleSet();
			case MetricsPackage.METRIC_SOURCE__METRIC_RETENTION_RULE_SET:
