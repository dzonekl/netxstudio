...
public class GenericsActionBarContributor
	...
	/**
	 * Action to create objects from the Generics model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			GenericsModelWizard wizard = new GenericsModelWizard();
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(NetxstudioEditorPlugin.INSTANCE.getString("_UI_GenericsEditor_menu"), "com.netxforge.netxstudio.delta16042013.genericsMenuID");
