...
import com.netxforge.netxstudio.delta16042013.generics.provider.GenericsItemProviderAdapterFactory;
...
import com.netxforge.netxstudio.delta16042013.metrics.provider.MetricsItemProviderAdapterFactory;
...
public class GenericsEditor
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(GenericsModelWizard.FILE_EXTENSIONS, "*.");
	...
	protected void updateProblemIndication() {
		if (updateProblemIndication) {
			BasicDiagnostic diagnostic =
				new BasicDiagnostic
					(Diagnostic.OK,
					 "com.netxforge.netxstudio.models.16042013_delta.editor",
					 0,
					 null,
	...
	public void doSaveAs() {
		...
		String[] files = NetxstudioEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
		if (files.length > 0) {
