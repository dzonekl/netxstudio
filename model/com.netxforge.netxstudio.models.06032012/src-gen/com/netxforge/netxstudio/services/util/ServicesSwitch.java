...
public class ServicesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ServicesPackage.SERVICE_FLOW: {
				ServiceFlow serviceFlow = (ServiceFlow)theEObject;
				T result = caseServiceFlow(serviceFlow);
				if (result == null) result = caseBase(serviceFlow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServicesPackage.SERVICE_FLOW_RELATIONSHIP: {
				ServiceFlowRelationship serviceFlowRelationship = (ServiceFlowRelationship)theEObject;
				T result = caseServiceFlowRelationship(serviceFlowRelationship);
				if (result == null) result = caseBase(serviceFlowRelationship);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Flow</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Flow</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServiceFlow(ServiceFlow object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Flow Relationship</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Flow Relationship</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServiceFlowRelationship(ServiceFlowRelationship object) {
		return null;
	}
