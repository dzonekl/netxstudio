 ...
 * @generated
 */
public class NetxstudioSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NetxstudioPackage.NETXSTUDIO: {
				Netxstudio netxstudio = (Netxstudio)theEObject;
				T result = caseNetxstudio(netxstudio);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Netxstudio</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Netxstudio</em>'.
