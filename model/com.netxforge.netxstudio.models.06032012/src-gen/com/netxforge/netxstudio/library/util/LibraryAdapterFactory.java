...
public class LibraryAdapterFactory extends AdapterFactoryImpl {
	...
	protected LibrarySwitch<Adapter> modelSwitch =
		new LibrarySwitch<Adapter>() {
			...
			@Override
			public Adapter caseReferenceNetwork(ReferenceNetwork object) {
				return createReferenceNetworkAdapter();
			}
			@Override
			public Adapter caseReferenceRelationship(ReferenceRelationship object) {
				return createReferenceRelationshipAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.netxforge.netxstudio.library.ReferenceNetwork <em>Reference Network</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createReferenceNetworkAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.netxforge.netxstudio.library.ReferenceRelationship <em>Reference Relationship</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createReferenceRelationshipAdapter() {
		return null;
	}
