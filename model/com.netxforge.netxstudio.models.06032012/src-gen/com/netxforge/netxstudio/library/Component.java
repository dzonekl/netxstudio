 ...
 *   <li>{@link com.netxforge.netxstudio.library.Component#getConfigAttributes <em>Config Attributes</em>}</li>
...
public interface Component extends Base {
	...
	/**
	 * Returns the value of the '<em><b>Config Attributes</b></em>' containment reference list.
	 * The list contents are of type {@link com.netxforge.netxstudio.generics.ConfigAttribute}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * The Lifecycle reference, contains 0 or 1
	 ...
	 * 							
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>Config Attributes</em>' containment reference list.
	 * @see com.netxforge.netxstudio.library.LibraryPackage#getComponent_ConfigAttributes()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='ConfigAttributes'"
	 * @generated
	 */
	EList<ConfigAttribute> getConfigAttributes();
