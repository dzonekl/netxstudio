...
public class LibraryFactoryImpl extends EFactoryImpl implements LibraryFactory {
	...
	public static LibraryFactory init() {
		try {
			LibraryFactory theLibraryFactory = (LibraryFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.netxforge.com/06032012/library"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case LibraryPackage.REFERENCE_NETWORK: return (EObject)createReferenceNetwork();
			case LibraryPackage.REFERENCE_RELATIONSHIP: return (EObject)createReferenceRelationship();
