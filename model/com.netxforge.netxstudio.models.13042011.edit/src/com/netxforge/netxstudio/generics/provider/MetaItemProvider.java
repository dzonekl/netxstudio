...
/**
 * This is the item provider adapter for a {@link com.netxforge.netxstudio.generics.Meta} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetaItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GenericsPackage.Literals.META__AUTHOR,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GenericsPackage.Literals.META__DESCRIPTION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GenericsPackage.Literals.META__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Meta_type") + " " + meta.isDeleted();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Meta.class)) {
			case GenericsPackage.META__DESCRIPTION:
			case GenericsPackage.META__VERSION:
