	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Marker_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Marker_description_feature", "_UI_Marker_type"),
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Marker_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Marker_kind_feature", "_UI_Marker_type"),
