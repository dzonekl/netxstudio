...
public class LibraryPackageImpl extends EPackageImpl implements LibraryPackage {
	...
	public EAttribute getNetXResource_DetailDisplay() {
		return (EAttribute)netXResourceEClass.getEStructuralFeatures().get(5);
	}
	...
	public EReference getNetXResource_UnitRef() {
		return (EReference)netXResourceEClass.getEStructuralFeatures().get(10);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getUnit_Code(), theGenericsPackage.getUnit(), "code", null, 0, 1, Unit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
