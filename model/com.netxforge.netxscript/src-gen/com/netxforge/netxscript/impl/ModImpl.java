...
public class ModImpl extends MinimalEObjectImpl.Container implements Mod
{
  ...
  {
    return NetxscriptPackage.Literals.MOD;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, NetxscriptPackage.MOD__NAME, oldName, name));
  }
  ...
  public EList<Import> getImports()
  {
    if (imports == null)
    {
      imports = new EObjectContainmentEList<Import>(Import.class, this, NetxscriptPackage.MOD__IMPORTS);
    }
    return imports;
  }
  ...
  public EList<Function> getFunctions()
  {
    if (functions == null)
    {
      functions = new EObjectContainmentEList<Function>(Function.class, this, NetxscriptPackage.MOD__FUNCTIONS);
    }
    return functions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case NetxscriptPackage.MOD__IMPORTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case NetxscriptPackage.MOD__NAME:
        return getName();
      case NetxscriptPackage.MOD__IMPORTS:
        return getImports();
      case NetxscriptPackage.MOD__FUNCTIONS:
