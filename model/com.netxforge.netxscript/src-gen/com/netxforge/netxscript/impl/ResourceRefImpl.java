 ...
 * <em><b>Resource Ref</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link com.netxforge.netxscript.impl.ResourceRefImpl#getResource <em>
 * Resource</em>}</li>
 * <li>{@link com.netxforge.netxscript.impl.ResourceRefImpl#getRangeRef <em>
 * Range Ref</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ResourceRefImpl extends LeafReferenceImpl implements ResourceRef {
	...
	/**
	 * The cached value of the '{@link #getRangeRef() <em>Range Ref</em>}'
			...
			if (resource != oldResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							NetxscriptPackage.RESOURCE_REF__RESOURCE,
	...
	public void setResource(NetXResource newResource) {
		...
		if (resource != null) {
			System.out.println("Setting Ref resource" + resource.getShortName());
			System.out.println("Setting Ref resource" + resource.getLongName());
			System.out.println("Setting Ref resource"
					+ resource.getExpressionName());
		}
		resource = newResource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NetxscriptPackage.RESOURCE_REF__RESOURCE, oldResource,
					resource));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRangeRef(RangeRef newRangeRef,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					NetxscriptPackage.RESOURCE_REF__RANGE_REF, oldRangeRef,
					newRangeRef);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRangeRef(RangeRef newRangeRef) {
		if (newRangeRef != rangeRef) {
			...
			if (rangeRef != null)
				msgs = ((InternalEObject) rangeRef).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- NetxscriptPackage.RESOURCE_REF__RANGE_REF,
						null, msgs);
			if (newRangeRef != null)
				msgs = ((InternalEObject) newRangeRef).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- NetxscriptPackage.RESOURCE_REF__RANGE_REF,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					NetxscriptPackage.RESOURCE_REF__RANGE_REF, newRangeRef,
					newRangeRef));
	}
