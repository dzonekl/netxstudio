...
/**
 * This is the item provider adapter for a {@link com.netxforge.netxstudio.library.Meta} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetaItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Meta_author_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Meta_author_feature", "_UI_Meta_type"),
				 LibraryPackage.Literals.META__AUTHOR,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Meta_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Meta_description_feature", "_UI_Meta_type"),
				 LibraryPackage.Literals.META__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LibraryPackage.Literals.META__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Meta)object).getAuthor();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Meta.class)) {
			case LibraryPackage.META__AUTHOR:
			case LibraryPackage.META__DESCRIPTION:
			case LibraryPackage.META__VERSION:
