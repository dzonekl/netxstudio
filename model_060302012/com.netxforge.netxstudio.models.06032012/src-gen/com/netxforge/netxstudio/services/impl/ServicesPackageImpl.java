...
public class ServicesPackageImpl extends EPackageImpl implements ServicesPackage {
	 ...
	 * @generated
	 */
	private EClass serviceFlowEClass = null;
	 ...
	 * @generated
	 */
	private EClass serviceFlowRelationshipEClass = null;
	 ...
	 * @generated
	 */
	private EEnum serviceFlowDirectionEEnum = null;
	 ...
	 * @generated
	 */
	private EDataType serviceFlowDirectionObjectEDataType = null;
	 ...
	 * @generated
	 */
	public EClass getServiceFlow() {
		return serviceFlowEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getServiceFlow_ServiceFlowRelationships() {
		return (EReference)serviceFlowEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getServiceFlow_Name() {
		return (EAttribute)serviceFlowEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getServiceFlowRelationship() {
		return serviceFlowRelationshipEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getServiceFlowRelationship_ReferenceRelationship() {
		return (EReference)serviceFlowRelationshipEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EEnum getServiceFlowDirection() {
		return serviceFlowDirectionEEnum;
	}
	 ...
	 * @generated
	 */
	public EDataType getServiceFlowDirectionObject() {
		return serviceFlowDirectionObjectEDataType;
	}
	...
	public void createPackageContents() {
		...
		serviceFlowEClass = createEClass(SERVICE_FLOW);
		createEReference(serviceFlowEClass, SERVICE_FLOW__SERVICE_FLOW_RELATIONSHIPS);
		createEAttribute(serviceFlowEClass, SERVICE_FLOW__NAME);
		...
		serviceFlowDirectionEEnum = createEEnum(SERVICE_FLOW_DIRECTION);
		...
		serviceFlowDirectionObjectEDataType = createEDataType(SERVICE_FLOW_DIRECTION_OBJECT);
	}
	...
	public void initializePackageContents() {
		...
		serviceFlowEClass.getESuperTypes().add(theGenericsPackage.getBase());
		serviceFlowRelationshipEClass.getESuperTypes().add(theGenericsPackage.getBase());
		...
		initEClass(serviceFlowEClass, ServiceFlow.class, "ServiceFlow", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getServiceFlow_ServiceFlowRelationships(), this.getServiceFlowRelationship(), null, "serviceFlowRelationships", null, 0, -1, ServiceFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getServiceFlow_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, ServiceFlow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(serviceFlowDirectionEEnum, ServiceFlowDirection.class, "ServiceFlowDirection");
		addEEnumLiteral(serviceFlowDirectionEEnum, ServiceFlowDirection.LEFTTORIGHT);
		addEEnumLiteral(serviceFlowDirectionEEnum, ServiceFlowDirection.RIGHTTOLEFT);
		...
		initEDataType(serviceFlowDirectionObjectEDataType, ServiceFlowDirection.class, "ServiceFlowDirectionObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getServiceFlow_ServiceFlowRelationships(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "ServiceFlowRelationships"
		   });			
		addAnnotation
		  (getServiceFlow_Name(), 
		   source, 
		...
		addAnnotation
		  (serviceFlowDirectionEEnum, 
		   source, 
		   new String[] {
			 "name", "ServiceFlowDirection"
		   });		
		addAnnotation
		  (serviceFlowDirectionObjectEDataType, 
		   source, 
		   new String[] {
			 "name", "ServiceFlowDirection:Object",
			 "baseType", "ServiceFlowDirection"
		   });			
		addAnnotation
		  (serviceFlowRelationshipEClass, 
		   source, 
		   new String[] {
			 "name", "ServiceFlowRelationship",
			 "kind", "elementOnly"
		   });			
		addAnnotation
		  (getServiceFlowRelationship_ReferenceRelationship(), 
		   source, 
		   new String[] {
			 "kind", "element",
