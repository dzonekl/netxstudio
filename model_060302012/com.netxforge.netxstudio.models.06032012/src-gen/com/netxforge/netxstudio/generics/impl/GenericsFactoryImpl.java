...
public class GenericsFactoryImpl extends EFactoryImpl implements GenericsFactory {
	...
	public static GenericsFactory init() {
		try {
			GenericsFactory theGenericsFactory = (GenericsFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.netxforge.com/06032012/generics"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case GenericsPackage.CONFIG_ATTRIBUTE: return (EObject)createConfigAttribute();
