 ...
 * All Rights Reserved.
 */
package com.netxforge.screens.editing.base.dialogs;
...
public class CheckedTableSelectionDialog extends SelectionStatusDialog {
	...
	private String fEmptyListMessage = "List is empty";
	...
	private IStatus fCurrStatus = new Status(IStatus.OK, "TODO_PLUGIN_ID", "");

	/**
	 * Constructs an instance of
	 * &lt;code&gt;ElementTreeSelectionDialog&lt;/code&gt;.
	 * 
	 * @param labelProvider
	...
	protected void updateOKStatus() {
		if (!fIsEmpty) {
			if (fValidator != null) {
				...
				// CB Status requires a plugin_id.
				fCurrStatus = new Status(IStatus.ERROR, "TODO_ID", "error");
			}
		} else {
			// CB Status requires a plugin_id.
			fCurrStatus = new Status(IStatus.ERROR, "TODO_ID",
					fEmptyListMessage);
		}
		updateStatus(fCurrStatus);
	}
	...
	private Composite createSelectionButtons(Composite composite) {
		...
		Button deselectButton = createButton(buttonComposite,
				IDialogConstants.DESELECT_ALL_ID, "Delesect All", false); //$NON-NLS-1$
