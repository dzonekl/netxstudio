...
public class RFServiceToRFServiceEditPart extends AbstractConnectionEditPart {

	public RFServiceToRFServiceEditPart(RFServiceToRFService stn) {
		this.setModel(stn);
	}

	public RFServiceToRFService getRFSServiceToRFService() {
		return (RFServiceToRFService) this.getModel();
	}
	...
	public void activate() {
		...
		for (Object child : manager.getChildren()) {
			...
			if (part.addRFServiceToRFServiceTargetConnection(this)) {
		...
		manager.addEditPartListener(new EditPartListener.Stub() {
			...
			public void childAdded(EditPart child, int index) {
				...
				AbstractEditPart part = (AbstractEditPart) child;
				if (part.addRFServiceToRFServiceTargetConnection(RFServiceToRFServiceEditPart.this)) {
	...
	public void deactivate() {
		...
		for (Object child : manager.getChildren()) {
			AbstractEditPart part = (AbstractEditPart) child;
			if (part.removeRFServiceToRFServiceTargetConnection(this)) {
