...
public class MappingTypeDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		Button btnXlsMapping = formToolkit.createButton(composite_1,
				"XLS Mapping", SWT.RADIO);
		...
		Button btnCsvMapping = formToolkit.createButton(composite_1,
				"CSV Mapping", SWT.RADIO);
		...
		Button btnRdbmsMapping = formToolkit.createButton(composite_1,
				"RDBMS Mapping", SWT.RADIO);
	...
	protected void configureShell(Shell shell) {
		...
		shell.setText("Select the mapping type for this Metric Source");
	}
